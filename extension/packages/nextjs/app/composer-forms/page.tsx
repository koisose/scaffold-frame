...
const Home: NextPage = () => {
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center ">
        <input type="text" className="border border-gray-400 px-4 py-2 rounded-md" />
      ...
      <div className="flex justify-center my-5">
        <button className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded w-24">Share</button>
      </div>
    </>
  );
};
